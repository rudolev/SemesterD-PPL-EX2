...
// import { applyEnv, makeEmptyEnv, makeExtEnv, Env as FrameEnv } from "./L3-env-env";
...
// const applicativeEval = (exp: CExp, env: FrameEnv): Result<Value> =>
...
// export const evalSequence = (seq: Exp[], env: FrameEnv): Result<Value> =>
//     isNonEmptyList<Exp>(seq) ? evalCExps(first(seq), rest(seq), env) : 
//     makeFailure("Empty sequence");
    
// const evalCExps = (first: Exp, rest: Exp[], env: FrameEnv): Result<Value> =>
...
// const evalDefineExps = (def: DefineExp, exps: Exp[], env: FrameEnv): Result<Value> =>
...
// const evalLet = (exp: LetExp, env: FrameEnv): Result<Value> => {
...
// // L31
// const evalClass = (exp: ClassExp, env: FrameEnv): Result<Value> => {
